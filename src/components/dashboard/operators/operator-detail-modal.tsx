...
interface Props { member: OperatorMember | null; onClose: () => void; }

export default function OperatorDetailModal({ member, onClose }: Props) {
  const { t } = useLang();
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">{t("Operations Team", "فريق التشغيل")} · #{member.id}</p>
            </div>
          </div>
