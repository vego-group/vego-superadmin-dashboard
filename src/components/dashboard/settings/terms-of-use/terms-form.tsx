  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
      <div className="px-6 py-5 border-b border-gray-100">
        <h2 className="text-base font-semibold text-gray-900">{t("Edit Terms of Use", "تعديل شروط الاستخدام")}</h2>
        <p className="text-xs text-gray-400 mt-1">{t("Update your terms of use content and legal information", "قم بتحديث محتوى شروط الاستخدام والمعلومات القانونية")}</p>
      </div>

      <div className="p-6">
        <label className="block text-sm text-gray-700 mb-2">
          {t("Terms Content", "محتوى الشروط")} <span className="text-red-500 ml-0.5">*</span>
        </label>
