// src/components/dashboard/cabinates/battery-swapping/cabinet-filters.tsx
"use client";
...
export default function CabinetFilters({
  search,
  onSearchChange,
  statusFilter,
  onStatusChange,
      ...
      <div className="flex items-start justify-between mb-4">
        <div>
          <h2 className="text-lg sm:text-xl font-semibold text-gray-900">
            {t("Battery Swapping Cabinets", "خزائن تبديل البطاريات")}
          </h2>
          <p className="text-xs sm:text-sm text-gray-500 mt-0.5">
            {t("Manage all battery swapping cabinet locations", "إدارة جميع مواقع خزائن تبديل البطاريات")}
          </p>
        </div>
        <button
          onClick={onAdd}
        ...
        >
          ...
          <span className="hidden xs:inline">{t("Add Cabinet", "إضافة خزانة")}</span>
      ...
      <div className="flex flex-wrap items-center gap-2 sm:gap-3">
        ...
        <div className="relative flex-1 min-w-[160px]">
          ...
          <input
            ...
            placeholder={t("Search cabinets…", "بحث في الخزائن…")}
